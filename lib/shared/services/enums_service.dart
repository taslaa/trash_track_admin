...
class EnumsService {
  ...
  Future<Map<int, String>> getVehicleTypes() async {
    final response = await http
        .get(Uri.parse('http://localhost:7034/api/Enums/vehicle-types'));
  ...
  Future<Map<int, String>> getGarbageTypes() async {
    final response = await http
        .get(Uri.parse('http://localhost:7034/api/Enums/garbage-types'));
  ...
  Future<Map<int, String>> getReportStates() async {
    final response = await http
        .get(Uri.parse('http://localhost:7034/api/Enums/report-states'));
