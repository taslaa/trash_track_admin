...
class _GarbageMapScreenState extends State<GarbageMapScreen> {
  ...
  // Replace with your actual base service instance
  ...
  Future<void> _fetchGarbageLocations() async {
    // Fetch garbage locations using your base service's getPaged method
    try {
      final SearchResult<Garbage> result = await _garbageService.getPaged();

      // Create markers for each garbage location
          ...
          children: [
            ...
            if (garbage != null)
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Description: ${garbage!.description}'),
